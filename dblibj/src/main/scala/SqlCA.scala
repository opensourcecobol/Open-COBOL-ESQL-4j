...
class SqlCA(
  ...
  def setCaid(caid: Array[Byte]): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
  def setAbc(abc: Int): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
  def setCode(code: Int): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
  def setErrml(errml: Short): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
  ...
  def setErrp(errp: Array[Byte]): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
  def setErrd(errd: Array[Int]): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
  def setWarn(warn: Array[Byte]): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
  def setState(state: Array[Byte]): SqlCA =
    new SqlCA(caid, abc, code, errml, errmc, errp, errd, warn, state)
}
