...
class GlobalState(
  ...
  def setConnectionMap(connectionMap: ConnectionMap): GlobalState =
    new GlobalState(
      connectionMap,
      rollbackOneMode,
      cursorMap,
  ...
  def setRollBackOneMode(rollbackOneMode: Boolean): GlobalState =
    new GlobalState(
      connectionMap,
      rollbackOneMode,
      cursorMap,
  ...
  def setCursorMap(cursorMap: CursorMap): GlobalState = new GlobalState(
    connectionMap,
    rollbackOneMode,
    cursorMap,
    sqlVarQueue,
  ...
  def setSqlVarQueue(sqlVarQueue: Queue[SQLVar]): GlobalState = new GlobalState(
    connectionMap,
    rollbackOneMode,
    cursorMap,
    sqlVarQueue,
  ...
  def setSqlResVarQueue(sqlResVarQueue: Queue[SQLVar]): GlobalState =
    new GlobalState(
      connectionMap,
      rollbackOneMode,
      cursorMap,
  ...
  def setQueryInfoMap(queryInfoMap: QueryInfoMap): GlobalState =
    new GlobalState(
      connectionMap,
      rollbackOneMode,
      cursorMap,
  ...
  def setOccursInfo(occursInfo: OccursInfo): GlobalState = new GlobalState(
    connectionMap,
    rollbackOneMode,
    cursorMap,
    sqlVarQueue,
...
object GlobalState {
  ...
  def initialGlobalState: GlobalState = new GlobalState(
    ConnectionInfo.emptyConnectionMap,
    false,
    Cursor.emptyCursorMap,
    Queue.empty,
    Queue.empty,
    Map.empty,
    OccursInfo.defaultValue
  )
}
